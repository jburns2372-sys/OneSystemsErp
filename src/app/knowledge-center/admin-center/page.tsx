...
export default async function AiKnowledgeCenterPage() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      {/* Phase 13 AI Admin Settings UI */}
      <div style={{ marginTop: '30px', padding: '20px', borderRadius: '12px', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--glass-border)' }}>
        <h2 style={{ fontSize: '1.2rem', margin: '0 0 15px 0' }}>⚙️ AI Engine Configuration</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px' }}>
          <div style={{ padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '5px' }}>Primary Engine</div>
            <div style={{ fontWeight: 'bold' }}>OpenAI GPT-4o-mini</div>
          </div>
          <div style={{ padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '5px' }}>Embeddings Model</div>
            <div style={{ fontWeight: 'bold' }}>text-embedding-3-small</div>
          </div>
          <div style={{ padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '5px' }}>RAG Pipeline</div>
            <div style={{ fontWeight: 'bold', color: '#51cf66' }}>Active & Synced</div>
          </div>
          <div style={{ padding: '15px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '5px' }}>Audit Logging</div>
            <div style={{ fontWeight: 'bold', color: '#51cf66' }}>Enforced</div>
          </div>
        </div>
      </div>
    </div>
