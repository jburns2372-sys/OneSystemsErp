...
const filePath = path.join('c:/Users/user/Documents/JD SOFTWARE PROJECTS/PGH-PMS/public/uploads/accomplishments', 'v2-1781009184232-734291750-Project_Accomplishment_Report_Template.xlsx');
...
for (let r = range.s.r; r <= range.e.r; r++) {
    const cell = ws[XLSX.utils.encode_cell({r: r, c: 1})]; // Col 2 is Description
...
if (foundRow !== -1) {
    ...
    console.log("Mobilization not found");
}
